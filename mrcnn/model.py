...
class MaskRCNN():
    ...
    def set_log_dir(self, model_path=None):
        ...
        self.log_dir = "/home/zakieh/Desktop/code_cnn/environments/t2/train-custom/logs"
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        if not os.path.exists(self.log_dir):
            ...
            self.set_log_dir("/home/zakieh/Desktop/code_cnn/environments/t2/train-custom/logs")
            os.makedirs(self.log_dir)
            print(self.log_dir)
